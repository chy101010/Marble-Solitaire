...
/**
 * This interface represents the operations offered by the marble solitaire model: managing game
 * state and enforcing the rules. One object of the model represents one game of marble solitaire.
 */
